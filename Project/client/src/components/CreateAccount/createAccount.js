...
import { Autocomplete, Container, Card, CardContent, Typography, TextField, Button, createTheme, ThemeProvider, CssBaseline, Box, Grid } from '@mui/material';
    ...
    <Grid container>
          ...
          <Grid item md={6} sx={{ position: 'relative' }}>
            ...
            <CardContent sx={{ p: 5 }}>
              ...
              <TextField label="Faculty Email (.ac.nz)" variant="standard" 
               id="email"
               value={form.email}
              ...
              <Autocomplete
                ...
                onChange={(event, value) => updateForm({ department: value ? value.label : "" })}
              />
            ...
            <Typography variant="body2" sx={{ mb: 2, textAlign: 'center' }}>
              Disclaimer: OtagoMarketplace is a platform for members (faculty and staff) of the University of Otago.              
            </Typography>   
            </CardContent>
            </Card>
          </Grid>
